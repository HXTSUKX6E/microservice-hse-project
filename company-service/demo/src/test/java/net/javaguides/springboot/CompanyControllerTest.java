...
public class CompanyControllerTest {
    ...
    private static List<Company> getCompanies() throws ParseException {
        ...
        Company company1 = new Company(inn, kpp, ogrn, address, director, date_reg, isAccepted);
        Company company2 = new Company("52", kpp, ogrn, address, director, date_reg, isAccepted);
